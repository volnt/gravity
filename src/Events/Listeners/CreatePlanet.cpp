...
{
  if (event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left && !universe.getObjectAtCursor())
    {
  ...
  else if (event.type == sf::Event::MouseButtonReleased && event.mouseButton.button == sf::Mouse::Left && _movingObject)
    {
  ...
  else if (event.type == sf::Event::MouseMoved && _movingObject)
    {
